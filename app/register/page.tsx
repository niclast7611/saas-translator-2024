...
async function RegisterPage(props: Props) {
  const session = await getServerSession(authOptions);

  return (
    <div className="isolate overflow-hidden bg-gray-900 h-full pb-40">
      <div className="mx-auto max-w-7xl px-6 pb-96 pt-16 text-white text-center lg:px-8">
